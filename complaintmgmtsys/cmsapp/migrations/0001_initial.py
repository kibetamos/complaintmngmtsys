# Generated by Django 5.1.6 on 2025-05-22 08:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[(3, 'superadmin'), (2, 'compuser'), (1, 'admin')], default=1, max_length=50)),
        ...
        migrations.AddField(
            model_name='complaints',
            name='assigned_team',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='cmsapp.team'),
        ),
        migrations.CreateModel(
            name='TeamMember',
            fields=[
                ...
                ('team', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='members', to='cmsapp.team')),
