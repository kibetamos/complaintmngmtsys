...
#ADDING TEAMS TO THE ADMIN
    # path('superuser/home/', adminviews.superuserhome, name="superuserhome"),


    path('Admin/add-team/', adminviews.ADD_TEAM, name="add_team"),
    path('Admin/manage-team/', adminviews.MANAGE_TEAM, name="manage_team"),
    path('Admin/manage-team/<int:id>/', adminviews.MANAGE_TEAM, name='manage_team'),
    path('Admin/delete-team/<int:id>/', adminviews.DELETE_TEAM, name="delete_team"),
    path('UpdateTeam/<str:id>', adminviews.UPDATE_TEAM, name='update_team'),
    path('UpdateTeamDetails', adminviews.UPDATE_TEAM_DETAILS, name='update_team_details'),
    # path('UpdateTeamDetails/', adminviews.UPDATE_TEAM_DETAILS, name='update_team_details'),
